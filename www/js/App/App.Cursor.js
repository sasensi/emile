App.Cursor = {};
App.Cursor.addEventListener = multiTouchListener;

function multiTouchListener(target) {

	var cursorDown  = target.oncursordown,
		cursorMove  = target.oncursormove,
		cursorUp    = target.oncursorup,
		logMessage  = null;
    ...
    function DoEvent(theEvtObj) {
        ...
        for (var i = 0; i < pointerList.length; ++i) {
            ...
            // App.log(NumberOfKeys(lastXYById) + ',' + pointerId + '  ' + theEvtObj.type)
            ...
            var args = {target:target, id:pointerId, clientX:targetRelativeX(pageX), clientY:targetRelativeY(pageY), point:[targetRelativeX(pageX), targetRelativeY(pageY)]};
